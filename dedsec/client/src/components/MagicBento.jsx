...
const cardData = [
  {
    ...
    description: 'Advanced penetration testing and security assessments',
    label: 'Security'
  },
  {
    color: '#060010',
    title: 'Threat Intelligence',
    description: 'Real-time monitoring and vulnerability research',
    label: 'Intelligence'
  },
  {
    color: '#060010',
    title: 'Digital Resistance',
    description: 'Fighting for digital freedom and privacy rights',
    label: 'Activism'
  },
  {
    color: '#060010',
    title: 'Exploit Development',
    description: 'Zero-day research and advanced exploit techniques',
    label: 'Research'
  },
  {
    color: '#060010',
    title: 'Network Infiltration',
    description: 'Sophisticated network analysis and penetration',
    label: 'Network Ops'
  },
  {
    color: '#060010',
    title: 'Cyber Warfare',
    description: 'Strategic offensive and defensive operations',
    label: 'Warfare'
  }
];
      ...
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            /* Card 2 - Small top left next to card 1 */
            .card-responsive .card:nth-child(2) {
              grid-column: 2;
              grid-row: 1;
            }

            /* Card 3 - BIG top right (2 cols x 2 rows) */
            .card-responsive .card:nth-child(3) {
              grid-column: 3 / span 2;
              grid-row: 1 / span 2;
            }

            /* Card 4 - BIG bottom left (2 cols x 2 rows) */
            ...
            /* Card 6 - Small bottom right next to card 5 */
